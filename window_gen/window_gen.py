...
def gen_windows(img, x_s_t=[None, None], y_s_t=[None,None], xy_w=(32,32), xy_overlap=(0.6,0.6),sweep=7):
    if None in x_s_t:
        x_s_t = [0, img.shape[1]]
    if None in y_s_t:
        y_s_t = [0, img.shape[0]]
    ...
    #define window sizes
    w_sizes = np.linspace(32,270,6, dtype="int32") #array([  32.,   48.,   64.,   80.,   96.,  112.,  128.])
    w_sizes = np.linspace(32,270,6, dtype="int32") #array([  32.,   48.,   64.,   80.,   96.,  112.,  128.])
...
if __name__ == '__main__':
    ...
    w = gen_windows(img, y_s_t= [380, 700])
    f1,f2= w[0]
    print("-"*20)
    print("-"*20)
